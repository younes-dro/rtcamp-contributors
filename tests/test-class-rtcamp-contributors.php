...
class Test_RTCamp_Contributors extends WP_UnitTestCase {
    ...
    public function test_displaying_contributors_box() {
        ...
        $post_id = $this->factory->post->create(['post_content' => 'This is a test post.']);
    
        $user1 = $this->factory->user->create(['role' => 'author', 'display_name' => 'Author One']);
        $user2 = $this->factory->user->create(['role' => 'editor', 'display_name' => 'Editor One']);
        $user3 = $this->factory->user->create(['role' => 'administrator', 'display_name' => 'Admin One']);
